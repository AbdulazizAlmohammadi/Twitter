...
namespace Twitter.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<TweetModel>().HasData(new TweetModel { TweetId = 1, TweetContent = "Hi I am new member here", TweetDate = "2005-09-01", UserId = 1 });
            builder.Entity<TweetModel>().HasData(new TweetModel { TweetId = 2, TweetContent = "I like MVC and c#", TweetDate = "2018-08-01", UserId = 2 });
            builder.Entity<TweetModel>().HasData(new TweetModel { TweetId = 3, TweetContent = "Do you want to learn more about FrontEnd?", TweetDate = "2012-12-01", UserId = 3 });

            //Seeding profile 

            builder.Entity<ProfileModel>().HasData(new ProfileModel { ProfileId = 1, ProfileName = "Nada", ProfilePicture = "https://i.pinimg.com/originals/0a/53/c3/0a53c3bbe2f56a1ddac34ea04a26be98.jpg", Bio = "Hardcore coffeeaholic. Thinker. Twitter maven. Problem solver. Evil travel lover.", TotalFollowers = 34, TotalFollowing = 434, NumberOfTweets = 31, DateOfJoin = "2005-09-05" , UserId = 1 });
            builder.Entity<ProfileModel>().HasData(new ProfileModel { ProfileId = 2, ProfileName = "I love cats", ProfilePicture = "https://i.redd.it/v0caqchbtn741.jpg", Bio = "Pop culture evangelist. Devoted internet nerd. Tv fanatic. Web maven. Typical travel aficionado. Thinker.", TotalFollowers = 1000, TotalFollowing = 234, NumberOfTweets = 752, DateOfJoin = "2005-10-10", UserId = 2 });
            builder.Entity<ProfileModel>().HasData(new ProfileModel { ProfileId = 3, ProfileName = "Taif", ProfilePicture = "https://i.pinimg.com/originals/bc/b8/36/bcb83616190f26847422d44363434400.jpg", Bio = "Wannabe bacon geek. Social media evangelist. Web maven. Twitter scholar. ", TotalFollowers = 200, TotalFollowing = 4534, NumberOfTweets = 435, DateOfJoin = "2005-08-01", UserId = 3 });
